...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat);
            ...
            //Hardcoded some emojis
//        String emoji = new String(new int[] { 0x1F60A }, 0, 1);
        final TextView smileemoji = (TextView) findViewById(R.id.textView3);
        smileemoji.setText(new String(Character.toChars(0x1F60A)));
        final TextView emoji2 = (TextView) findViewById(R.id.textView4);
        emoji2.setText(new String(Character.toChars(0x1F60B)));
        final TextView emoji3 = (TextView) findViewById(R.id.textView5);
        emoji3.setText(new String(Character.toChars(0x1F60C)));
        final TextView emoji4 = (TextView) findViewById(R.id.textView6);
        emoji4.setText(new String(Character.toChars(0x1F60D)));
        final TextView emoji5 = (TextView) findViewById(R.id.textView7);
        emoji5.setText(new String(Character.toChars(0x1F699)));
        final TextView emoji6 = (TextView) findViewById(R.id.textView8);
        emoji6.setText(new String(Character.toChars(0x1F6A7)));
